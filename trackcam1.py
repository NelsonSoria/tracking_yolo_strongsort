...
URL = "https://9ca2-45-162-74-17.ngrok-free.app/detectar"
            ...
            if det is not None and len(det):
                ...
                if len(outputs[i]) > 0:
                    for output in outputs[i]:
                        ...
                        log2 = {'ncam': 1, 'id': id, 'time': current_time, 'x': float(x_center), 'y': float(y_center)}
...
def save_to_csv(log_data, filename="cam1_tracking.csv"):
